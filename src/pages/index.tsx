  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover HR Management Application - Your Ultimate Solution for Streamlining HR Processes, Enhancing Employee Engagement, and Driving Organizational Success"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover HR Management Application - Your Ultimate Solution for Streamlining HR Processes, Enhancing Employee Engagement, and Driving Organizational Success`}
            </Text>
            <Box
