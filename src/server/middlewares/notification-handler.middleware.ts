...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'An application has been submitted by a new applicant..create': {
    roles: ['owner', 'hr-manager', 'hr-assistant'],
    key: 'application_submitted',
    tenantPath: [],
    userPath: [],
  },
  'An application has been reviewed by the HR Assistant..update': {
    roles: ['owner', 'hr-manager'],
    key: 'application_reviewed',
    tenantPath: [],
    userPath: [],
  },
  'An applicant has been hired by the HR Manager..create': {
    roles: ['owner', 'hr-assistant', 'employee'],
    key: 'employee_hired',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['owner', 'hr-manager', 'applicant', 'hr-assistant', 'employee'];
